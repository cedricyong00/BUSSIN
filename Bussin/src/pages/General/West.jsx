...
import {
  ...
  const mockdata = [
    ...
    },
    {
      title: "WHICH AREA?",
      description:
        "Choa Chu Kang, Jurong East, Boon Lay, Joo Koon, Pioneer, NTU",
    },
    {
  ...
  export function WestPage() {
    ...
    return (
      <>
        <Image src={West} className={classes.image} />
        <Container size="lg" py="xl">
          ...
          <Text c="dimmed" className={classes.description} ta="center" mt="md">
            ...
            THE STADIUM to MRT STATIONS IN THE WEST AREA IN SINGAPORE ON-DEMAND
